        ...
        <!-- 风格 -->
          <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/adminPage/notice"><i class="fa fa-fw fa-calendar-minus-o"></i><span>公告</span></a></li>
                <li class=" active"><a href="/adminPage/information"><i class="fa fa-fw fa-gear"></i><span>博客信息</span></a></li>
